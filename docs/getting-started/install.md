...
the API: `find_package(core-cpp 0.3)` accepts 0.3.z and refuses 0.4.0.
...
```cmake
CPMAddPackage(NAME core-cpp GITHUB_REPOSITORY contour-terminal/core-cpp GIT_TAG v0.3.0
