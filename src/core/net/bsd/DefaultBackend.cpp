...
///
/// Which backend macOS and the BSDs build: kqueue by preference, poll(2) beside it.
/// CMake compiles exactly one DefaultBackend.cpp — this one here — which is how no
/// `#ifdef` chooses a backend (Ruling R40).
