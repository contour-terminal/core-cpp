...
| `src/core/platform/UserPaths_test.cpp` | contour-terminal/endo | `src/platform/WindowsPlatform_test.cpp` | `f774a210ce989e5947b8f61d715068b1dc96088c` | the `homeDirectory`/`configHome` cases, over a `core::testing::FakeEnvironment` instead of the process environment; plus a core-cpp case for the zero-argument overloads |
